export type Project = { name: string, emoji: string, technologies: string, year: string, shortDescription: string,
                        longDescription: string, screenshot: string, githubLink?: string, projectLink?: string };
